...
public class TemplateService {
    ...
    // 유저의 커스텀 템플릿 조회
    // todo : 페이지 네이션 필요한가?
    public List<TemplateResponseDto> findCustomTemplatesByUser(FindTemplateByMemberIdRequestDto dto) {
        Member member = memberService.findById(dto.getUserId());
    ...
    public void updateTemplate(UpdateTemplateRequestDto dto) {
        Template template = findById(dto.getTemplateId());
